...
def sight_height_distance(df3, df4, book2, sheet2, BC1, path1, path2, num, dict1):
...
for m in range(int(qi_shu)):  # len(RZ_values)
    ...
    sight_height_distance(df3, df4, book2, sheet2, BC2, path_output3, path_output2, num,dict1)
    pat1 = path_output1+'\\'
        ...
        if (pat_name[z1][-4:] == 'xlsx'):
            if (re.findall(r'数据(.*)', pat_name[z1])[0] != '无支点.xlsx'):
                ...
                for i in range(0, rown):
                    ...
                    if (i == 0):
                        fid1.write(
                            'For M5|Adr' + '   ' + index1 + '|' + 'KD1' + dmlength + '                  ' + '1' + '|' + "                      " + '|' + "                      " + '|' + 'Z' + '        ' + baoliu(
                        ...
                        if ((~numpy.isnan(data1.iloc[i, 4])) and (~numpy.isnan(data1.iloc[i, coln - 1]))):
                            ...
                            if (len(baoliu3(str(data1.iloc[i, 6]))) == 6):
                                fid1.write('For M5|Adr' + '   ' + index1 + '|' + 'KD1' + dmlength + '      ' + str(
                                    ...
                                    str(round(data1.iloc[i, 4],
                                              5))) + ' ' + 'm' + '   ' + '|' + 'HD' + '         ' + baoliu3(
                                    str(round(data1.iloc[i, 6], 3))) + ' m' + '   ' + '|' + 'Z' + '        ' + baoliu5(
                            ...
                            fid1.write('For M5|Adr' + '   ' + index1 + '|' + 'KD1' + dmlength + '      ' + str(
                                data1.iloc[
                                    i, 2]) + '    ' + '1' + '|' + '                      ' + '|' + '                      ' + '|' + 'Z' + '        ' + baoliu5(str(round(data1.iloc[i, coln - 1],5))) + ' m' + '   ' + '|' + '\n')
                ...
                if (len(re.findall(r'(.*)[.]', str(round(dbz, 3)))[0]) == 3):
                    fid1.write('For M5|Adr' + '   ' + index3[
                        1] + '|' + 'KD1' + dmlength1 + '      ' + czs1 + '        ' + '1' + '|' + 'Db' + '        ' + baoliu3(
                        str(round(dbz, 3))) + ' m' + '   ' + '|' + 'Df' + '        ' + baoliu3(
                        str(round(dfz, 3)) + ' m' + '   ' + '|' + 'Z' + '        ' + baoliu(
                            str(data1.iloc[i, coln - 1])) + ' m' + '   ' + '|' + '\n'))
                else:
                    fid1.write('For M5|Adr' + '   ' + index3[
                        1] + '|' + 'KD1' + dmlength1 + '      ' + czs1 + '        ' + '1' + '|' + 'Db' + '        ' + baoliu3(
