...
class zhu_ti_cj_jiang(QWidget):
    def __init__(self):
        ...
        self.label2.setText('主体沉降')
        self.pushbutton2=QPushButton(self)
        self.pushbutton2.setText('主体沉降原始数据')
        self.label5=QLabel(self)
        self.label5.setText('基坑沉降')
        self.pushbutton5=QPushButton(self)
        self.pushbutton5.setText('基坑沉降原始数据')
        self.label3=QLabel(self)
        self.label3.setText('原始数据文件夹')
        self.pushbutton3=QPushButton(self)
        self.pushbutton3.setText('创建文件夹')
        self.label4=QLabel(self)
        self.label4.setText('更改文件的名字')
        self.pushbutton4=QPushButton(self)
        self.pushbutton4.setText('执行RENAME')
        self.label6 = QLabel(self)
        self.label6.setText('闭合差提取')
        self.pushbutton6 = QPushButton(self)
        self.pushbutton6.setText('执行提取闭合差程序')
